...
The program also handles I/O exceptions when reading and writing to the flat file databases (e.g. \mintinline{java}{FileNotFoundException}.
...
\mintinline{CustomerRegistryException} and \mintinline{AccountingSystemException} for
failures related to the other two databases.
The checked \emph{Reflective Operation exceptions}, like
\mintinline{java}{ClassNotFoundException}
and \mintinline{java}{InstantiationException},
are caught and rethrown
by the programs own unchecked exception for pricing strategies
(Factory-Method failure) called
\mintinline{java}{PricingFailureException} and by
the programs unchecked exception \mintinline{java}{RegistryHandlerException}
...
\mintinline{java}{IllegalStateException} is thrown.
